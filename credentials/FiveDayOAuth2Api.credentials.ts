...
export class FiveDayOAuth2Api implements ICredentialType {
	...
	properties: INodeProperties[] = [
		...
		},
		{
			...
			name: 'accessTokenUrl',
			type: 'hidden',
			default: 'https://gateway.dev.5daylabs.com/api/security/integration/auth/external/n8n/authorize',
			// default: 'https://gateway.qa.5daylabs.com/api/security/integration/auth/external/n8n/authorize',
